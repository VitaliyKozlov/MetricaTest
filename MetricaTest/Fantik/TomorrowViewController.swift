...
class TomorrowViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource  {
    ...
    func bindData () {
        dataRx
            .asDriver()
            .drive (tableView.rx.items(cellIdentifier: "cell2", cellType: TomorrowTableViewCell.self)) { (row, element, cell) in
...
extension UIViewController {
    func showAlertNoEvent () {
        let alert = UIAlertController(title: "Warning!", message: "No sporting events scheduled.", preferredStyle: UIAlertController.Style.alert)
